...
int OrderedBinarySearchIterative(int A[], int n, int data);
...
int main()
{
  ...
  pos = OrderedBinarySearchIterative(A, n, data);
...
int OrderedBinarySearchIterative(int A[], int high, int data)
{
  int low = 0, mid = 0;
